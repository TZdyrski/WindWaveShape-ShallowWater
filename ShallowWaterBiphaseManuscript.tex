...
amplitude $a$, the depth $h$, the gravitational acceleration $g$, and
the wind speed $U$ expressed as a pressure magnitude $P \propto \rho_a
U^2$.
...
\begin{equation*}
  ...
  \end{aligned}
\end{equation*}
Here, we have defined the parameters $\epsilon \coloneqq a/h$, $\mu
