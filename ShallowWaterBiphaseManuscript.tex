...
If we take $\psi_P = 3\pi/4$, we get
\[
  P'_M \alpha = \num{1.4e-3} y \Bqty{b-q \mathcal{H}[y - 1]}
\]
with $y$ given above.
...
find
\[
  y = \num{3.2e-2} \pqty{U_{10} \SI{0.11}{\second\per\meter} - 1}^2
\]
For $U_{10} < \SI{56}{\meter\per\second}$, we have
\[
  P'_M \alpha = \SI{3.1e-6}{\second\squared\per\meter\squared} U_{10}^2
\]
For instance, $U_{10} = \SI{50}{\meter\per\second}$ gives
$P'_M \alpha = \num{5.3e-3} \approx \epsilon^2$.
...
\[
  P'_M \alpha = \SI{2.1e-4}{\second\squared\per\meter\squared} U_{10}^2
\]
For instance, $U_{10} = \SI{21}{\meter\per\second}$ gives
$P'_M \alpha = \num{8.3e-2} \approx \epsilon^2$.
