...
Now, we choose $k_E$:
\begin{equation}
  k_E \coloneqq k = \frac{2\pi}{\lambda}
\end{equation}

Finally, we can now fix $m$ as a function of $\mu$ and $\epsilon$ using
\cref{eq:nondim_lambda}:
\begin{equation}
  k_E = \frac{2 \pi}{\lambda} = \frac{2 \pi k_E}{\lambda'}
  = \frac{2 \pi k_E}{2 K(m) \Delta'}
  \implies \Delta' = \frac{\pi}{K(m)} \,.
\end{equation}
So, as $m \to 0$, $\Delta' \to 1$, while $m \to 1$ yields $\Delta \to
0$.
However, using \cref{eq:nondim_cnoidal_params}, we have
\begin{equation}
  \frac{\pi}{K(m)} = \Delta ' = \sqrt{\frac{12 \mathcal{C}}{\mathcal{B}}
    \frac{m}{H'}}
  = \sqrt{\frac{12 \mathcal{C}}{\mathcal{B}} \frac{m}{2}}
  \implies m K(m)^2 = \frac{\pi^2 \mathcal{B}}{6 \mathcal{C}} \,.
\end{equation}
For our particular values of $\mathcal{B} = 3/2$ and $\mathcal{C} =
\mu/(6 \epsilon)$, we have
\begin{equation}
  m K(m)^2 = \frac{3 \pi**2}{2} \frac{\epsilon}{\mu} \,.
\end{equation}
This is an implicit equation for $m$ in terms of $\epsilon \coloneqq
a/h$ and $\mu \coloneqq (kh)^2$.
...
\begin{equation}
  ...
  &\qquad= \int_{-L/2}^{L/2} \frac{1}{2} P_J (\eta_0')^2 \dd{x}
