...
\Citet{zdyrski2020wind} found that the GM forcing produced an asymmetry
in the same direction as laboratory experiments, while Jeffreys produced
the wrong sign.
However, in this study, we find that that shallow water waves have the
opposite asymmetry from their deep water counterparts, for both the
Jeffreys and GM forcings.
Thus, the Jeffreys forcing generates asymmetry of the correct sign in
shallow water, and GM is of the wrong sign.
Note that results for GM forcings were not included here: the GM forcing
is most applicable to periodic waves (\eg Stokes waves or cnoidal
waves), and it produces unphysical effects such as the growth of higher
harmonics under offshore winds.
