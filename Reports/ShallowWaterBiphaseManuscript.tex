...
\begin{figure}
  ...
  \caption{
    The difference between the surface profile and $\sech^2$, solitary
...
To further examine the wind-induced wave asymmetry, we subtract off the
unforced solitary wave component from $\eta$.
