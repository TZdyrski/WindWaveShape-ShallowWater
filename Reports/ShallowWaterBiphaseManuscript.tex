...
\begin{figure}
  ...
  \caption{
    ...
    reference solitary wave \cref{eq:initial_condition} under
...
We subtract the reference solitary wave of the appropriate height from
the profile $\Delta \eta(x) \coloneqq \eta -
\eta_{\text{ref}}$ and plot it as a function of the reference
wave-centered distance $\tilde{x} \coloneqq x -
x_{\text{ref}}$ in \cref{fig:snapshots_solitary_tail}.
