...
changes.
The wave profile's deviation from a reference solitary wave shows an
...
\approx \pm 3$~(\cref{fig:snapshots_solitary_tail}).
...
wave had the form of an bound, dispersive tail, with differing sign for
