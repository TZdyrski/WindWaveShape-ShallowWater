...
In \cref{sec:results}, we noted that the rear faces ($x<0$) of the waves
...
on the water approaching the front face of the wave is negligible and
...
the asymmetry for onshore and offshore winds in
\cref{fig:statistics_solitary:c}.
...
effects.
Furthermore, these effects were enhanced for strong pressures, reducing
