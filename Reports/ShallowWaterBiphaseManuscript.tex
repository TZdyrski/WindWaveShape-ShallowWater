...
numerical studies have begun incorporating wind-induced changes to the
wave field using coupled air-water
simulations~\citep[\eg][]{liu2010numerical,hao2019wind} or direct
numerical simulations of two-fluid flows~\citep[\eg][]{yang2018direct}.
\end{LineLabel}
...
\begin{LineLabel}{R4-10}
These well-understood waves are often used to study fluid
dynamical~\citep[\eg][]{munk1949solitary,lin1998numerical,monaghan1999solitary}
and engineering~\citep[\eg][]{lin2004numerical,xu2018prediction}
phenomena owing to their simplicity.
\end{LineLabel}
...
fluid dynamical
systems~\citep[\eg][]{lin1998numerical,monaghan1999solitary,xu2018prediction},
...
\end{LineLabel}
This is expected due to the dependence of (unforced) solitary waves'
nonlinear phase speed $c = H/2$ on the growing/decaying wave height $H$
(\cf{} \cref{eq:nonlin_phase_speed}).
\end{LineLabel}
...
For simplicity, we approximate the nonlinear phase speed $c$
\cref{eq:nonlin_phase_speed} with the linear phase speed $c_0 =
\sqrt{gh}$ (giving an error of only \SI{10}{\percent} for this case) and
combine this with \cref{eq:gamma_vs_P_solitary} to give
\begin{equation}
...
of solitary waves with different values of $\mu_E$, implying that these
