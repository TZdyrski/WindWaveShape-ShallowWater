...
$\eta_0 \partial_x \eta_0$ and have the form in a co-moving frame of
...
To further examine the wind-induced wave asymmetry, we fit $\eta$
(minimizing the $L_1$ difference) to a solitary wave profile
\cref{eq:initial_condition} giving the reference solitary wave's height
$H'_{\text{ref}}(t'_1)$ and peak location $x'_{\text{ref}}(t'_1)$.
...
\begin{equation}
  ...
  - H'_{\text{ref}}(t'_1) \sech^2\pqty{\frac{\tilde{x}'}{\Delta'}}
  \qq{with}
  \Delta' = \sqrt{\frac{8}{H'_{\text{ref}}(t'_1)}} \,.
