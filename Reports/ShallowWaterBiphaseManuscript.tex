...
perturbation expansion is only valid for time intervals of order
$\order{1/\epsilon}$, and we limit our analysis to short times removing
the need to regularize the solution.
\end{LineLabel}
...
crest (\cref{fig:snapshots_solitary:a}), whereas the onshore wind causes
...
instead yields $b = \num{0.10081 \pm 0.00003}$, close to the analytic
approximation.
\end{LineLabel}
...
Prior studies on shallow-water, KdV solitary waves have also noted that
