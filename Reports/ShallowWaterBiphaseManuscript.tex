...
We will quantify the wave shape via the wave height $H$,
\begin{equation}
  H = \max(\eta) - \min(\eta) \,,
  \label{eq:height_def}
\end{equation}
...
Since this definition caries a factor of the domain size $\sqrt{L'}$, we
normalize the skewness $\Sk$ by the initial skewness $\Sk_0$.
