...
For an initial condition, we use solitary wave solutions of the unforced
($P=0$) KdV equation.
Using the solution from \citet{mei2005nonlinear}, the solitary wave
solution to the KdV equation is
\begin{equation}
