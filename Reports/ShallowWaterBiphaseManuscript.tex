...
and $P<0$ asymmetries arises from the rear half of the wave.
...
While this parameterization is meant for periodic waves, we will
assume it holds approximately for solitary waves and take $\lambda = 2
\pi/k_E = \SI{20}{\meter}$, corresponding to a depth of $h =
...
Hence, the front face of the wave is largely unaffected by the pressure
forcing.
For the onshore wind case, the water rising on the front face of the
wave encounters low air pressure, and the water descending on the rear
face encounters high air pressure, both of which increase the water's
energy.
...
precludes a comparison to experimental data as was done in
