...
We are parameterizing our wave by four quantities: the depth, bottom
horizontal velocity, wave height, and wavelength.
We will choose the bottom horizontal velocity to vanish:
\begin{equation}
...
Finally, we assume the surface pressure $p(x,t)$ is given by a
