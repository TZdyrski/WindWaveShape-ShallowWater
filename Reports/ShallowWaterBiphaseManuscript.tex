...
slow time scale, and then the wave evolves a dispersive tail on a fast
time scale according to inverse scattering transform of the unforced KdV
equation.

\begin{LineLabel}{R1-12}
Unlike dispersive tails generated from initial conditions which fail to
