...
dynamical~\citep[\eg][]{munk1949solitary,lin1998numerical} and
...
nonlinear phase speed deviation from the linear phase speed, $\Delta c =
c-c_0 = \epsilon H/2$, on the growing/decaying wave height $H$ (\cf{}
\cref{eq:nonlin_phase_speed}).
\end{LineLabel}
...
\end{LineLabel}
\begin{LineLabel}{R4-15}
Future investigations could include coupling the Jeffrey's pressure term
to a higher order Boussinesq model~\citep[\eg][]{dommermuth1987high} or
to couple an atmospheric LES to such a higher-order Boussinesq
model~\citep[\eg][]{dommermuth1987high}, as was done for deep water by
\citet{hao2019wind}.
\end{LineLabel}
