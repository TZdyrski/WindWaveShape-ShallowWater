...
perturbation expansion is only valid for time intervals of
$\order{T_0/\epsilon}$, and we limit our analysis to short times
removing the need to regularize the solution.
\end{LineLabel}
