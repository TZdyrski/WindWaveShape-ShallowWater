...
\begin{equation}
  \mathcal{L}_0[h_0] \coloneqq
    -c_1 h_0' + \frac{3}{2} h_0 h_0' + \frac{1}{6} \frac{\mu}{\epsilon}
    h_0^{(3)} = 0 \,,
  \label{eq:L0_kernel}
\end{equation}
...
\begin{equation}
  \mathcal{L}_0 \coloneqq -c_1 \pdv{\theta} + \frac{3}{2} h_0
    \pdv{\theta} + \frac{1}{6} \frac{\mu}{\epsilon} \pdv[3]{\theta} \,,
  \label{eq:L0_def}
\end{equation}
...
\begin{equation}
  -c_1 h_0 + \frac{3}{4} h_0^2 + \frac{1}{6} \frac{\mu}{\epsilon} h_0''
    = B_1 \,.
\end{equation}
Multiplying by $h_0'$ and integrating again gives
\begin{equation}
  -c_1 h_0^2 + \frac{1}{4} h_0^3 + \frac{1}{12} \frac{\mu}{\epsilon}
    \pqty{h_0'}^2 = B_1 h_0 + B_2 \,,
\end{equation}
which implies
\begin{equation}
  \frac{1}{3} \frac{\mu}{\epsilon} \pqty{h_0'}^2 = - h_0^3 + 4 c_1 h_0^2
    + B_1 h_0 + B_2
...
\begin{equation}
  \eta_0 = H_2 + (H_3 - H_2) \cn^2\bqty{\frac{1}{2}\sqrt{\frac{3
      \epsilon}{\mu}} \sqrt{H_3 - H_1} \pqty{x - t_0 - c_1 t_1}} \,.
  \label{eq:eta0_cn}
\end{equation}
